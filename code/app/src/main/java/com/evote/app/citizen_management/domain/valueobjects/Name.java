...
public record Name(String firstName, String lastName) {
  ...
  /**
   * Prüft, ob der Vorname nicht null oder leer ist und den Validierungsregeln (nur Buchstaben, 3–10
   * Zeichen, inkl. Umlaute) entspricht.
   *
  ...
  /**
   * Prüft, ob der Nachname nicht null ist und den Validierungsregeln (nur Buchstaben, 3–10 Zeichen,
   * inkl. Umlaute) entspricht.
   *
