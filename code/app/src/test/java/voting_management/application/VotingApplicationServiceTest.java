...
public class VotingApplicationServiceTest {
  ...
  void setup() {
    ...
    // Dummy Publisher reicht (wir testen hier nicht den Listener, nur dass nichts null ist)
    eventPublisher = event -> {
    };

    // Dummy AuthPort reicht (castVote wird hier nicht getestet, aber authPort darf nicht null sein)
    authPort = token -> Optional.of(new PseudonymToken("test-pseudonym"));
