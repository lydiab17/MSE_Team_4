...
class OptionLabelTest {
  ...
  void nullValue_throwsException() {
    assertThrows(NullPointerException.class, () -> new OptionLabel(null));
  }
  ...
  void emptyOrBlank_throwsException(String raw) {
    assertThrows(IllegalArgumentException.class, () -> new OptionLabel(raw));
  }
  ...
  @ValueSource(
      strings = {"Ja!", "Nein?", "Vielleicht.", "Option_1", "Option-1", "Ja/Nein", "Ja, Nein"})
