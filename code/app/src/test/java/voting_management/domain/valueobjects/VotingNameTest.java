...
class VotingNameTest {
  ...
  void nullValue_throwsException() {
    assertThrows(NullPointerException.class, () -> new VotingName(null));
  }
  ...
  void emptyOrBlank_throwsException(String raw) {
    assertThrows(IllegalArgumentException.class, () -> new VotingName(raw));
  }
  ...
  void tooShort_throwsException() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new VotingName(name));
  }
