...
/**
 * Diese Exception wird ausgelöst, wenn bei der Registrierung eines Citizens
 * eine E-Mail-Adresse angegeben wird, die bereits einem bestehenden
...
public class UserAlreadyExistsException extends Exception {
     ...
     *
     * Erstellt eine neue Exception mit einer Fehlermeldung,
     * die die betroffene E-Mail-Adresse enthält.
     *
