 ...
 *
 * <p>Ziel: - Überprüfen, ob Events korrekt gespeichert, gelesen und gelöscht werden
 */
class EventStoreTest {
  ...
  /**
   * Diese Methode wird vor JEDEM Test ausgeführt. So starten alle Tests mit einem leeren
   * EventStore.
   */
  @BeforeEach
  void setUp() {
   ...
   *
   * <p>Erwartung: - Nach dem Hinzufügen existiert genau ein Event - Das gespeicherte Event ist
   * genau das hinzugefügte Objekt
   */
  @Test
   ...
   *
   * <p>Erwartung: - Beide Events werden gespeichert - Die Anzahl der Events beträgt 2
   */
  @Test
   ...
   *
   * <p>Erwartung: - Events aus unterschiedlichen Keys werden gemeinsam zurückgegeben - Die
   ...
   *
   * <p>Erwartung: - Nach dem Aufruf von clear() ist der EventStore leer
   */
  @Test
  void clear_shouldRemoveAllEvents() {
    ...
    // Assert:
    assertTrue(
        eventStore.getEvents().isEmpty(), "Nach clear() sollten keine Events mehr vorhanden sein");
  }

  /**
   * Dummy-Implementierung von DomainEvent für Testzwecke.
   *
   * <p>Warum? - DomainEvent ist abstrakt - Für diese Tests interessiert das Verhalten des
   * EventStore, nicht der Inhalt des Events - Diese Klasse ist daher bewusst leer
   */
