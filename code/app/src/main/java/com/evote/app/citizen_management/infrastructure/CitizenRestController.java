 ...
 *
 * <p>Der {@code CitizenRestController} dient als technischer Adapter zwischen
 * der HTTP-Schicht und der Application-Schicht. Er nimmt HTTP-Requests entgegen,
 * wandelt eingehende JSON-Daten in DTOs um und delegiert die fachliche Verarbeitung
 * an den {@link CitizenService}.</p>
 *
 * <p>Der Controller enthält keine Geschäftslogik. Er ist ausschließlich für die
 * Kommunikation über HTTP sowie für die Übersetzung von Service-Ergebnissen in
 * HTTP-Responses zuständig.</p>
 */
@RestController
...
public class CitizenRestController {
     ...
     *
     * <p>Die übergebenen Registrierungsdaten werden an den {@link CitizenService}
     * weitergeleitet. Das vom Service zurückgegebene Domain-Objekt wird anschließend
     * in ein Response-DTO umgewandelt.</p>
     *
     ...
     *
     * <p>Bei erfolgreichem Login wird ein Authentifizierungs-Token erzeugt und sowohl
     * im Response-Body als auch im {@code Authorization}-Header zurückgegeben.
     * Bei fehlgeschlagener Authentifizierung wird der HTTP-Status 401 zurückgegeben.</p>
     *
     ...
     *
     * <p>Der aktuell authentifizierte Benutzer wird über den Security-Kontext
     * ermittelt. Die zugehörigen Bürgerdaten werden über den {@link CitizenService}
     * geladen und als Response-DTO zurückgegeben.</p>
     *
