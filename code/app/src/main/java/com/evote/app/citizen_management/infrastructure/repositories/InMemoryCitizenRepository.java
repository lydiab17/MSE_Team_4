 ...
 *
 * <p>Diese Implementierung speichert {@link Citizen}-Objekte in einer einfachen {@link Map} im
 * Arbeitsspeicher.
 */
@Repository
public class InMemoryCitizenRepository implements CitizenRepository {
   ...
   *
   * <p>Der Schlüssel ist die eindeutige {@link Email}, der Wert das zugehörige {@link
   * Citizen}-Objekt.
   */
  ...
  /** Entfernt alle gespeicherten {@link Citizen}-Einträge aus dem In-Memory-Speicher. */
  @Override
  public void clear() {
    store.clear();
  }
  ...
  /**
   * Sucht einen {@link Citizen} anhand seiner E-Mail-Adresse im In-Memory-Speicher.
   *
   * @param email die eindeutige E-Mail-Adresse des Bürgers
   * @return ein {@link Optional} mit dem gefundenen {@link Citizen} oder {@link Optional#empty()},
