...
class CitizenTest {
  ...
  void shouldThrowExceptionWhenNameIsNull() {
    assertThrows(NullPointerException.class, () -> Citizen.create(null, email, password));
  }

  @Test
  @DisplayName("Sollte Exception werfen, wenn Email null ist")
  void shouldThrowExceptionWhenEmailIsNull() {
    assertThrows(NullPointerException.class, () -> Citizen.create(name, null, password));
  }

  @Test
  @DisplayName("Sollte Exception werfen, wenn Passwort null ist")
  void shouldThrowExceptionWhenPasswordIsNull() {
    assertThrows(NullPointerException.class, () -> Citizen.create(name, email, null));
  }
}
