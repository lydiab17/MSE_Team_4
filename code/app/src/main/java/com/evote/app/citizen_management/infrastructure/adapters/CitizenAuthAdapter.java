 ...
 *
 * <p>Diese Klasse stellt eine Implementierung des {@link AuthPort} dar und fungiert als Brücke
 * zwischen dem Voting-Management-Kontext und dem Citizen-Management-Kontext.
 *
 * <p>Der Adapter validiert Authentifizierungs-Tokens und erzeugt daraus pseudonymisierte Tokens, um
 * die Identität eines Bürgers zu schützen.
 */
@Component
public class CitizenAuthAdapter implements AuthPort {
   ...
   *
   * <p>Das übergebene {@link AuthToken} wird validiert. Ist das Token ungültig oder kann keine
   * Bürger-ID ermittelt werden, wird ein leeres {@link Optional} zurückgegeben.
   *
   * <p>Bei erfolgreicher Validierung wird die ermittelte Bürger-ID pseudonymisiert, um eine
   * Weiterverarbeitung ohne Offenlegung der tatsächlichen Identität zu ermöglichen.
   *
   * @param token das zu prüfende Authentifizierungs-Token
   * @return ein {@link Optional} mit {@link PseudonymToken} bei erfolgreicher Verifikation,
