 ...
 *
 * <p>Der Projector verarbeitet {@link DomainEvent}s, die zuvor vom Aggregator
 * erzeugt wurden, und projiziert diese in ein konkretes Read Model.</p>
 *
 * <p>Er enthält keine fachlichen Entscheidungen, sondern setzt ausschließlich
 * das um, was durch Domain Events bereits entschieden wurde.</p>
 */
@Service
public class CitizenProjector {
    ...
    /**
     * Verarbeitet eine Liste von Domain Events und projiziert alle
     * unterstützten Event-Typen in den aktuellen Systemzustand.
     * Koordination einer Menge von Events.
     *
     * <p>Nicht unterstützte Events werden ignoriert. Für jedes bekannte
     * Event wird die entsprechende {@code apply}-Methode aufgerufen.</p>
     *
     ...
     *
     * <p>Aus den im Event enthaltenen Daten wird ein neues {@link Citizen}
     * erzeugt und anschließend im {@link CitizenRepository} persistiert.</p>
     *
