 ...
 *
 * <p>Dieses Response-DTO enthält ausschließlich die Informationen, die für die Darstellung eines
 * Bürgers nach außen vorgesehen sind, und kapselt damit die interne Datenstruktur.
 *
...
public record CitizenResponseDto(String email, String vorname, String nachname) {
   ...
   *
   * <p>Die Methode übernimmt nur die für den Client relevanten Felder und stellt damit eine saubere
   * Trennung zwischen interner Datenrepräsentation und externer Antwort sicher.
   *
