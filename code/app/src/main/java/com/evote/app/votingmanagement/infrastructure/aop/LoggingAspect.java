 ...
 * <p>
 * Loggt alle Methodenaufrufe im VotingApplicationService:
...
public class LoggingAspect {
    ...
    /**
     * Around-Advice für alle öffentlichen Methoden
     * im VotingApplicationService.
     * <p>
     * Pointcut:
     * execution(public * com.evote.app.votingmanagement.application.services.VotingApplicationService.*(..))
     */
    @Around("execution(public * com.evote.app.votingmanagement.application.services.VotingApplicationService.*(..))")
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            long duration = System.currentTimeMillis() - start;
            log.error("xxx {} threw {} after {} ms", methodName, ex.toString(), duration);
