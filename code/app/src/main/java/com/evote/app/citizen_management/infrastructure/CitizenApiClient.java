...
/**
 * Infrastruktur-Komponente zur Kommunikation mit dem Citizen-Backend.
 * Diese Klasse kapselt HTTP-Aufrufe für Registrierung und Login
 * und übernimmt die Serialisierung der Request-Daten.
 */
@Component
public class CitizenApiClient {
    ...
    /**
     * Führt einen Login-Vorgang über das Backend aus und liefert
     * bei Erfolg ein Authentifizierungs-Token zurück.
     *
     * @param email E-Mail-Adresse des Bürgers
     * @param password Passwort des Bürgers
