...
public class VotingTest {
  ...
  // ---------- Happy Path ----------
  // prüft den idealen Ablauf, also den normalen, erwarteten Fall, in dem alles korrekt eingegeben
  // wird und keine Fehler auftreten.
  @Test
  @DisplayName(
      "Erstellung: gültige Eingaben erzeugen Voting; Status=false; isOpen abhängig von Status")
  ...
  void edge_nameExactlyMinLength() {
    String name =
        "Abstimmung"; // 10 Zeichen? -> A b s t i m m n g (9) – also lieber explizit bauen:
  ...
  void edge_infoExactlyMinLength() {
    ...
    Voting v =
        Voting.create(4, "Abstimmung XX", info, today, today.plusDays(2), opts("Ja", "Nein"));
    assertNotNull(v);
  }
  ...
  void options_tooFew() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Voting.create(12, name, info, today, end, options));
  }
  ...
  void options_tooMany() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Voting.create(13, name, info, today, end, tooMany));
  }
  ...
  void options_duplicatesNotAllowed() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Voting.create(14, name, info, today, end, options));
  }
  ...
  void dates_invalidOrder() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Voting.create(17, name, info, start, end, options));
  }
  ...
  void nullValues_throwException() {
    ...
    assertThrows(
        NullPointerException.class, () -> Voting.create(21, null, info, today, end, options));
